...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.openshiftpipelinesV1alpha1, err = openshiftpipelinesv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.openshiftpipelinesV1alpha1 = openshiftpipelinesv1alpha1.NewForConfigOrDie(c)
